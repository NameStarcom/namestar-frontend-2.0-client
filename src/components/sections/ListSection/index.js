...
const DomainSection = (props) => {
    ...
    const listDomains = _.filter(props.domains, function (o) {
        return _.split(o.name, '.')[0].length > 5;
    });

    const domains = _.take(listDomains, 10);
    ...
    return (
        ...
        >
            <div
                className={classNames(
                    'flex',
                    'container px-4 mx-auto xl:max-w-[64rem] sm:px-6 lg:px-8 mb-8',
            ...
            >
                <div className={classNames('w-full', mapMaxWidthStyles(sectionWidth))}>
                    ...
                    <List domains={domains} whois={whois} variant={props.variant} isAutoPlay={props.isAutoPlay} />
