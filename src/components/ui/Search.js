                ...
                <div className="pt-12 pb-24 2xl:pb-44 bg-blueGray-100">
                    <div className="container px-4 py-4 mx-auto">
                        ...
                        <div className="flex flex-wrap py-5 mb-14 xl:mb-16 border-b border-black border-opacity-10">
                            <div className="w-full sm:w-1/3 lg:w-1/6 py-2 sm:px-3">
                                <a
                            ...
                            <div className="relative w-full sm:w-1/3 lg:w-1/6 py-2 sm:px-3">
                                <a
                                    className="flex items-center py-5 px-8 xl:px-12 font-heading font-medium border border-gray-200 hover:border-gray-300 rounded-4xl"
                                    href="#"
                                >
                                ...
                                <div className="relative z-50 -top-16 transform -translate-y-1">
                                    <div className="absolute py-3 px-5 bg-blueGray-100 w-full border border-blue-400 rounded-3xl">
                                        <a
                                            className="flex items-center justify-between py-1 px-7 leading-7 font-heading font-medium underline bg-white rounded-xl"
                                            href="#"
                                        >
                                            <span>Best seller</span>
                                            <img
                                                src="https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/uinel-assets/elements/ecommerce-product-list/check-black.svg"
                                                alt=""
                                            />
                                        </a>
                                        <a className="flex items-center justify-between py-1 px-7 leading-7 font-heading font-medium rounded-xl" href="#">
                                            Unpopular
                                        </a>
                                        <a className="flex items-center justify-between py-1 px-7 leading-7 font-heading font-medium rounded-xl" href="#">
                                            All
                        ...
                        <div className="sm:flex sm:flex-wrap mb-24">
                            <div className="sm:pr-7 mb-10 sm:mb-0 sm:w-1/2 lg:w-4/12 xl:w-3/12">
                                <div className="mb-10 xl:mb-16">
                                    ...
                                    <a
                                        className="flex items-center justify-between py-5 px-10 mb-3 bg-white bg-opacity-50 font-heading font-medium rounded-3xl"
                                        href="#"
                                    >
                                    ...
                                    <a
                                        className="flex items-center justify-between py-5 px-10 mb-6 bg-white bg-opacity-50 font-heading font-medium rounded-3xl"
                                        href="#"
                                    >
                                        <span>Smartwatch</span>
                                        <span className="text-sm text-gray-300">209</span>
                                    </a>
                                    <div className="sm:mx-auto sm:max-w-max">
                                        <a
                                            className="block py-3 px-10 w-full text-xl leading-7 text-white font-medium tracking-tighter font-heading text-center bg-blue-500 hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-xl"
                                            href="#"
                                        >
                                            All
                                        </a>
                                ...
                                <div className="mb-10 xl:mb-16">
                                    ...
                                    <div className="flex flex-wrap max-w-xs">
                                        <div className="p-1 m-2 mx-3 max-w-max border border-gray-300 rounded-full">
                                            <a className="block w-5 h-5 bg-blue-400 rounded-full" href="#"></a>
                                        </div>
                                        <div className="p-1 m-2 mx-3 max-w-max border border-opacity-0 rounded-full">
                                            <a className="block w-5 h-5 bg-orange-400 rounded-full" href="#"></a>
                                        </div>
                                        <div className="p-1 m-2 mx-3 max-w-max border border-opacity-0 rounded-full">
                                            <a className="block w-5 h-5 bg-black rounded-full" href="#"></a>
                                        </div>
                                        <div className="p-1 m-2 mx-3 max-w-max border border-opacity-0 rounded-full">
                                            <a className="block w-5 h-5 bg-red-400 rounded-full" href="#"></a>
                                        </div>
                                        <div className="p-1 m-2 mx-3 max-w-max border border-opacity-0 rounded-full">
                                            <a className="block w-5 h-5 bg-green-400 rounded-full" href="#"></a>
                                        </div>
                                        <div className="p-1 m-2 mx-3 max-w-max border border-opacity-0 rounded-full">
                                            <a className="block w-5 h-5 bg-purple-400 rounded-full" href="#"></a>
                                        </div>
                                        <div className="p-1 m-2 mx-3 max-w-max border border-opacity-0 rounded-full">
                                            <a className="block w-5 h-5 bg-yellow-400 rounded-full" href="#"></a>
                                        </div>
                                        <div className="p-1 m-2 mx-3 max-w-max border border-opacity-0 rounded-full">
                                            <a className="block w-5 h-5 bg-white rounded-full" href="#"></a>
                                        </div>
                                    </div>
                                </div>
                                <div className="mb-10 xl:mb-16">
                                    ...
                                    <div className="relative mb-28 mx-auto w-52 h-1 bg-white">
                                        ...
                                        <div className="relative left-20 max-w-max">
                                            ...
                                            >
                                                <img
                                                    className="absolute -left-20 top-2 max-w-max"
                                                    src="https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/uinel-assets/elements/ecommerce-product-list/toggle-bg-blue.svg"
                                                    alt=""
                                                />
                                            </a>
                                ...
                                <div className="py-10 px-11 mb-10 xl:mb-16 bg-purple-500 rounded-3xl">
                                    ...
                                    <div className="sm:flex sm:flex-wrap">
                                        <div className="p-1 w-full sm:w-1/2 md:w-1/3 lg:w-1/2 2xl:w-1/3">
                                            <a className="block py-5 px-4 text-center font-heading font-medium bg-white hover:bg-gray-50 rounded-3xl" href="#">
                                                32GB
                                            </a>
                                        </div>
                                        <div className="p-1 w-full sm:w-1/2 md:w-1/3 lg:w-1/2 2xl:w-1/3">
                                        ...
                                        <div className="p-1 w-full md:w-1/3 lg:w-full 2xl:w-1/3">
                                            <a
                                                className="block py-5 px-4 text-white text-center font-heading font-medium bg-indigo-400 hover:bg-indigo-500 rounded-3xl"
                                                href="#"
                                            >
                                                128GB
                                            </a>
                                ...
                                <div className="mb-10 xl:mb-11">
                                    ...
                                    <a className="flex items-center py-4 px-10 leading-8 font-heading font-medium bg-white bg-opacity-50 rounded-3xl" href="#">
                                        <span className="mr-6">
                                            <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect x="0.5" y="0.5" width="26" height="26" rx="5.5" fill="white" stroke="#DBDDE1"></rect>
                                            </svg>
                                        </span>
                                ...
                                <div>
                                    <img
                                        className="mb-3 -ml-4"
                                        src="https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/uinel-assets/elements/ecommerce-product-list/percent.svg"
                                        alt=""
                                    />
                                    <h2 className="mb-6 text-3xl lg:text-8xl leading-tight font-heading font-medium">Customers</h2>
                                        ...
                                        <div className="xl:flex xl:items-center p-10 xl:py-32 mb-8 bg-white rounded-3xl">
                                            <a className="block mx-auto max-w-max" href="#">
                                                <img
                                                    ...
                                                    src="https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/uinel-assets/images/ecommerce-product-list/iphone-12-pro.png"
                                                    alt=""
                                                />
                                            </a>
                                        </div>
                                    ...
                                    <div className="w-full lg:w-1/2 xl:w-1/3 px-2 mb-16 xl:mb-24">
                                        <div className="xl:flex xl:items-center p-10 xl:py-32 mb-8 bg-white rounded-3xl">
                                            <a className="block mx-auto max-w-max" href="#">
                                                <img
                                                    className="h-40 object-cover"
                                                    src="https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/uinel-assets/images/ecommerce-product-list/macbook-pro-17.png"
                                                    alt=""
                                                />
                                            </a>
                                        </div>
                                    ...
                                    <div className="w-full lg:w-1/2 xl:w-1/3 px-2 mb-16 xl:mb-24">
                                        <div className="xl:flex xl:items-center p-10 xl:py-32 mb-8 bg-white rounded-3xl">
                                            <a className="block mx-auto max-w-max" href="#">
                                                <img
                                                    className="h-40 object-cover"
                                                    src="https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/uinel-assets/images/ecommerce-product-list/smartwatch-green.png"
                                                    alt=""
                                                />
                                            </a>
                                        </div>
                                    ...
                                    <div className="w-full lg:w-1/2 xl:w-1/3 px-2 mb-16 xl:mb-24">
                                        <div className="xl:flex xl:items-center p-10 xl:py-32 mb-8 bg-white rounded-3xl">
                                            <a className="block mx-auto max-w-max" href="#">
                                                <img
                                                    className="h-40 object-cover"
                                                    src="https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/uinel-assets/images/ecommerce-product-list/macbook-pro-15.png"
                                                    alt=""
                                                />
                                            </a>
                                        </div>
                                    ...
                                    <div className="w-full lg:w-1/2 xl:w-1/3 px-2 mb-16 xl:mb-24">
                                        <div className="xl:flex xl:items-center p-10 xl:py-32 mb-8 bg-white rounded-3xl">
                                            <a className="block mx-auto max-w-max" href="#">
                                                <img
                                                    className="h-40 object-cover"
                                                    src="https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/uinel-assets/images/ecommerce-product-list/headphones-blacksaint.png"
                                                    alt=""
                                                />
                                            </a>
                                        </div>
                                    ...
                                    <div className="w-full lg:w-1/2 xl:w-1/3 px-2 mb-16 xl:mb-24">
                                        <div className="xl:flex xl:items-center p-10 xl:py-32 mb-8 bg-white rounded-3xl">
                                            <a className="block mx-auto max-w-max" href="#">
                                                <img
                                                    className="h-40 object-cover"
                                                    src="https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/uinel-assets/images/ecommerce-product-list/smartphone.png"
                                                    alt=""
                                                />
                                            </a>
                                        </div>
                                    ...
                                    <div className="w-full lg:w-1/2 xl:w-1/3 mb-16 xl:mb-0 px-2">
                                        <div className="xl:flex xl:items-center p-10 xl:py-32 mb-8 bg-white rounded-3xl">
                                            <a className="block mx-auto max-w-max" href="#">
                                                <img
                                                    className="h-40 object-cover"
                                                    src="https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/uinel-assets/images/ecommerce-product-list/xiaomi-camera.png"
                                                    alt=""
                                                />
                                            </a>
                                        </div>
                                    ...
                                    <div className="w-full lg:w-1/2 xl:w-1/3 mb-16 lg:mb-0 px-2">
                                        <div className="xl:flex xl:items-center p-10 xl:py-32 mb-8 bg-white rounded-3xl">
                                            <a className="block mx-auto max-w-max" href="#">
                                                <img
                                                    className="h-40 object-cover"
                                                    src="https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/uinel-assets/images/ecommerce-product-list/xiaomi-camera2.png"
                                                    alt=""
                                                />
                                            </a>
                                        </div>
                                    ...
                                    <div className="w-full lg:w-1/2 xl:w-1/3 px-2">
                                        <div className="xl:flex xl:items-center p-10 xl:py-32 mb-8 bg-white rounded-3xl">
                                            <a className="block mx-auto max-w-max" href="#">
                                                <img
                                                    className="h-40 object-cover"
                                                    src="https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/https://shuffle.dev/uinel-assets/images/ecommerce-product-list/smartwatch-blue.png"
                                                    alt=""
                                                />
                                            </a>
                                        </div>
