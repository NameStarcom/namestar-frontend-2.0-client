                        ...
                        <ul>
                                ...
                                <button className="flex w-full text-left">
                                    ...
                                    <div className="w-full mt-3">
                                        <div className="flex items-center justify-between">
                                            <h3 className="text-xl font-bold">How should I develop my workflow over time?</h3>
                                            <span className="ml-4">
                                                <svg
                                                    className="w-4 h-4"
                                                    width="18"
                                        ...
                                        <div className="mt-6 border-l-2 border-gray-50 pl-10">
                                            <p className="mb-5 text-xl">The point of using Lorem Ipsum is that it has a more-or-less normal:</p>
                            ...
                            <li className="mb-4 px-4 lg:px-12 py-8 bg-white rounded-2xl">
                                <button className="flex w-full text-left">
                                    ...
                                    <div className="w-full mt-3">
                                        ...
                                        <div className="hidden mt-6 border-l-2 border-gray-50 pl-10">
                                            <p className="text-xl">The point of using Lorem Ipsum is that it has a more-or-less normal:</p>
                                        </div>
                                    </div>
                                </button>
                            </li>
                            <li className="mb-4 px-4 lg:px-12 py-8 bg-white rounded-2xl">
                                <button className="flex w-full text-left">
                                    ...
                                    <div className="w-full mt-3">
                                        <div className="flex items-center justify-between">
                                            <h3 className="text-xl font-bold">How often should the app be updated?</h3>
                                            <span className="ml-4">
                                                <svg
                                                    className="w-4 h-4"
                                                    width="18"
                            ...
                            <li className="mb-4 px-4 lg:px-12 py-8 bg-white rounded-2xl">
                                <button className="flex w-full text-left">
                                    ...
                                    <div className="w-full mt-3">
                                        <div className="flex items-center justify-between">
                                            <h3 className="text-xl font-bold">Are Zospace apps free?</h3>
                                            <span className="ml-4">
                                                <svg
                                                    className="w-4 h-4"
                                                    width="18"
